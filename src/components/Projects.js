    ...
    <div className="max-w-7xl mx-auto py-16 md:pb-36 lg:pb-20 px-4 sm:px-6 lg:px-8 bg-zinc-900">
      ...
      <div className="relative w-full mt-12 lg:mt-12 flex-col justify-center align-middle">
        <img 
          ...
          alt="Project image"
        />
        <div className="w-full md:w-2/3 lg:w-1/2 md:mr-20 relative md:absolute -right-2 top-10 md:top-20 lg:top-14 text-left py-6 px-8 shadow-2xl bg-zinc-800 border-t-4 border-teal-700">
            ...
            <div className='flex justify-between w-5/12 md:w-1/3 mt-4'>
