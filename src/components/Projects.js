  ...
  return (
    <div className='bg-zinc-900'>
      <div className="max-w-7xl mx-auto py-16 md:pb-36 lg:pb-20 px-4 sm:px-6 lg:px-8">
        ...
        {/* PROJECT TWO */}
        <div className="relative w-full mt-28 flex-col justify-center align-middle">
          <img
            id='esImg' 
            className="rounded-xl w-full md:w-10/12 object-cover"
            src={dotts}
          ...
          />
          <div id='esAbout' className="w-full md:w-2/3 lg:w-1/2 md:mr-20 relative md:absolute md:-right-2 top-10 md:top-20 lg:top-14 text-left py-6 px-8 shadow-2xl bg-zinc-800 border-t-4 border-teal-700">
            <p className="text-gray-300 text-sm uppercase">In Progress</p>
            <h2 className="text-white pb-1">Dotts.io</h2>
            <p className="text-white text-sm leading-7"><b>The best messaging experience ever made. </b>Dotts.io is a new messaging app that puts user experience first with the widest range of customizable features available.</p>
            <a href='https://dotts.vercel.app/' target='_blank' className='no-underline'>
              <button
                type="button"
                className="inline-flex items-center px-4 py-2 shadow-sm text-base font-medium rounded-md text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
              >
            ...
            <div className='flex justify-between w-6/12 md:w-1/3 mt-4'>
              <i className="fab fa-js-square fa-2x text-zinc-500 ease-in-out duration-200 hover:-translate-y-2"></i>
              <i className="fab fa-node-js fa-2x text-zinc-500 ease-in-out duration-200 hover:-translate-y-2"></i>
              <i className="fab fa-react fa-2x text-zinc-500 ease-in-out duration-200 hover:-translate-y-2"></i>
            </div>
          </div>
        </div>
